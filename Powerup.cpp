...
Powerup::Powerup(double xP, double yP, powerType p) : GraphElement(xP, yP, POWERUP) { //nondefault constructor, passes position to GraphElement constructor [xPos, yPos, power]
	power = p;
...
Powerup::Powerup(double xP, double yP, double xV, double yV, powerType p) : GraphElement(xP, yP) { //nondefault constructor, passes position and velocity to GraphElement constructor [xPos, yPos, xVel, yVel, power]
	power = p;
